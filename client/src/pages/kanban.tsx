                    ...
                    <div className="flex items-center space-x-3">
                      ...
                      <div>
                        <h3 className="text-lg font-medium text-foreground cursor-pointer hover:text-primary transition-colors" 
                            ...
                            onClick={(e) => {
                              e.stopPropagation();
                              setLocation(`/workspace/app/detail/project/${project.id}?from=kanban`);
                            }}>
                          {project.name}
                        </h3>
                      </div>
            ...
            <div className="flex items-center space-x-3">
              ...
              <div>
                <h4 className="font-medium text-foreground cursor-pointer hover:text-primary transition-colors" 
                    ...
                    onClick={(e) => {
                      e.stopPropagation();
                      setLocation(`/workspace/app/detail/goal/${goal.id}?from=kanban`);
                    }}>
                  {goal.title}
                </h4>
              </div>
          ...
          <div className="space-y-3 flex-1">
            {statusTasks.map((task) => (
              <div 
                ...
                onClick={() => setLocation(`/workspace/app/detail/task/${task.id}?from=kanban`)}
              >
