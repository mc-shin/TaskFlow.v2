...
export default function TaskDetail() {
  ...
  const [attachedFiles, setAttachedFiles] = useState<
    Array<{ uploadURL: string; name: string; objectPath: string }>
  >([]);
                        ...
                        <div className="mt-1">
                          <Popover>
                            <PopoverTrigger asChild>
                              ...
                              >
                                {(editedTask.labels ?? task.labels ?? [])
                                  .length > 0 ? (
                                  (editedTask.labels ?? task.labels ?? []).map(
                                    (label, index) => (
                                      <Badge
                                        key={index}
                                        variant="outline"
                  ...
                  <div>
                    ...
                    {isEditing ? (
                      ...
                      >
                        ...
                        <SelectContent>
                          <SelectItem value="진행전" disabled>
                            진행전
                          </SelectItem>
                          <SelectItem value="진행중" disabled>
                            진행중
                          </SelectItem>
                          <SelectItem value="완료" disabled>
                            완료
                          </SelectItem>
                ...
                <CardContent>
                  <div className="space-y-3">
                    <ObjectUploader
                      ...
                      // }}
                      onGetUploadParameters={async () => {
                        // 🚩 [수정] fetch 대신 api.post 사용 및 불필요한 headers 제거
                        // -----------------------------------------------------------------
                            ...
                            >
                              ...
                              <div className="flex gap-2">
                                <Button
                                  ...
                                  onClick={async () => {
                                    try {
                                      // 🚩 [수정] fetch 대신 api.get 사용 및 responseType: 'blob' 설정
                                      // -----------------------------------------------------------------
                                      const response = await api.get(
                                        file.objectPath,
                                        {
                                      ...
                                      // Axios는 2xx 응답 시 response.data에 Blob 객체를 바로 담습니다.
                                      ...
                                      console.error("Download failed:", error);
                                      // toast 함수는 컴포넌트 환경에 따라 가정된 함수입니다.
                                      toast({
                                        title: "다운로드 실패",
                                        description:
                                          "파일 다운로드 중 오류가 발생했습니다.",
                                ...
                                <Button
                                  ...
                                  onClick={async () => {
                                    try {
                                      ...
                                      // Axios는 2xx 응답이 아니면 자동으로 에러를 던져 catch 블록으로 이동하므로,
                                      // 성공적인 경우(2xx)에는 추가적인 `if (response.ok)` 체크 없이 다음 로직을 실행합니다.
                                      // -----------------------------------------------------------------
                            ...
                            <div className="space-y-3">
                              ...
                              >
                                <SelectTrigger
                                  ...
                                  data-testid="select-task-progress"
                                >
                              ...
                              <Progress
                                value={
                                  editedTask.progress ?? task.progress ?? 0
                                }
                ...
                <CardContent className="space-y-4">
                  <div>
                    ...
                    <p
                      ...
                      data-testid="text-task-created-by"
                    >
                      {(() => {
                    ...
                    <p
                      ...
                      data-testid="text-task-created-at"
                    >
                      {task.createdAt
                        ? (() => {
                  ...
                  <div>
                    ...
                    <p
                      className="mt-1 text-sm"
                      data-testid="text-task-updated-by"
                    >
                      {(() => {
                    ...
                    <p
                      className="text-xs text-muted-foreground mt-1"
                      data-testid="text-task-updated-at"
                    >
                      {task.updatedAt
                        ? (() => {
