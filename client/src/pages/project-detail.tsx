                      ...
                      <div className="mt-1">
                        <Popover>
                          <PopoverTrigger asChild>
                            ...
                            >
                              {(editedProject.labels ?? project.labels ?? [])
                                .length > 0 ? (
                                (
                                  editedProject.labels ??
                                  project.labels ??
                                  []
                                ).map((label, index) => (
                                  <Badge
                              ...
                              <div className="flex gap-2">
                                <Button
                                  ...
                                  onClick={async () => {
                                    try {
                                      const objectPath =
                                        file.objectPath || file.uploadURL; // 경로 설정 로직은 유지

                                      // 🚩 [수정] fetch 대신 api.get 사용 및 응답 타입 지정
                                      // ----------------------------------------------------
                                      // Axios를 사용하여 파일 경로로 GET 요청을 보냅니다.
                                      // responseType: 'blob' 설정으로 응답을 Blob 형태로 받습니다.
                                      const response = await api.get(
                                      ...
                                      console.error("Download failed:", error);
                                      // 사용자에게 오류를 알리는 토스트 메시지 등을 추가할 수 있습니다.
                                    }
                                  }}
              ...
              {!isEditing && (
                <Card>
                  ...
                  <CardContent
                    ...
                    data-testid="goals-content-container"
                  >
                    {project.goals && project.goals.length > 0 ? (
                      ...
                      <div className="text-center py-8">
                        ...
                        >
                          <Plus className="h-4 w-4 mr-2" />첫 번째 목표 추가
                        </Button>
                      </div>
                    )}
                  </CardContent>
              ...
              <Card>
                ...
                <CardContent>
                  <div className="space-y-3">
                    ...
                    />
                    <div className="text-sm text-muted-foreground">
                      전체 작업 {goalTasks.length}개 중{" "}
                      {calculatedCompletedTasks.length}개 완료 (평균 진행도:{" "}
                      {averageProgress}%)
                    </div>
                  </div>
                </CardContent>
                          ...
                          {owners.map((owner, index) => (
                            ...
                            >
                              ...
                              <div>
                                <p
                                  className="font-medium"
                                  data-testid={`text-owner-name-${index}`}
                                >
                                  {owner.name}
                                </p>
                              </div>
                ...
                <CardContent className="space-y-4">
                  <div>
                    ...
                    <p
                      ...
                      data-testid="text-project-created-by"
                    >
                      {(() => {
                    ...
                    <p
                      ...
                      data-testid="text-project-created-at"
                    >
                      {project.createdAt
                        ? (() => {
                  ...
                  <div>
                    ...
                    <p
                      className="mt-1 text-sm"
                      data-testid="text-project-updated-by"
                    >
                      {(() => {
                    ...
                    <p
                      className="text-xs text-muted-foreground mt-1"
                      data-testid="text-project-updated-at"
                    >
                      {project.updatedAt
                        ? (() => {
